        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, "User"); //TODO: Role Options = "Admin", "User", "Developer", "Guest"

                    // Send confirmation email using MailerController
                    _mailerController.SendEmail(Input.Email, "Confirm your email",
