...
var handleRenderApexChart = function () {
	...
	//		{ name: 'Daily Used Car Apps', data: dailyUsedwData },
	...
	// apexRadialBarChartNew
	//var apexRadialBarChartOptionsNewApps = {
	//	chart: {
	//		height: 350,
	//		type: 'radialBar'
	//	},
	...
	//	series: [totalNewCarAppsData, totalNewCarValidatedData, totalNewCarSoldData, totalNewCarSoldData, totalNewCarNtuData, totalNewCarAppsPerDealData],
	//	labels: ['New Apps', 'Validated', 'Taken Up', 'Sold', 'Validated NTU', 'Apps Per Deal'],
	//	legend: {
	//		show: true,
	//		floating: true,
	//		position: 'left',
	...
	//	}
	//}
	//var apexRadialBarChartNewApps = new ApexCharts(
	//	document.querySelector('#apexRadialBarChartNewApps'),
	//	apexRadialBarChartOptionsNewApps
	//);
	//apexRadialBarChartNewApps.render();
